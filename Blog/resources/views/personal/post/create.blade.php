    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="/admin/post/create/new" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group w-25">
                                <label>New post name</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2" name="tag_ids[]" multiple="multiple" data-placeholder="Select tags"
                                        style="width: 100%;">
                                    @foreach($tags as $tag)
                                        <option {{ is_array('tag_ids') && in_array($tag->id, old('tag_ids')) ? 'selected': ''}} value="{{ $tag->id }}">{{$tag->title}}</option>
                                    @endforeach
                                </select>
                                @error('tag_ids')
                                <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-block btn-success btn-xs" value="Create">
                            </div>
                        </form>
                    </div>
                </div>
